...
```bash
cd benchmark
python evaluation/run_benchmark.py data/reasoning_sample.jsonl   --adapter models.base_adapter:EchoAdapter   --detector detectors.reasoning:ReasoningConsistencyDetector   --dataset-meta benchmark/data/reasoning_sample.yaml   --methodology benchmark/methodology/README.md#2-추론-오류-reasoning-errors   --report ../runs/2026-05-17-0600-echo-bundle/reasoning/report.json
```
...
```json
{
  ...
  "confidence": 0.0,
  "details": {
    "required": "drain, add_pasta, boil_water",
    "missing": "-"
  },
